...
public abstract class OwnedResourceDAO<Entity extends OwnedResource>  extends DAO<OwnedResourceRepository<Entity>, Entity>{
	...
	public List<Entity> findAllReadAccessible(){
        ...
        if(authentication instanceof AnonymousAuthenticationToken) {
            ...
            queryString = "select " + entity + " from " + entityName + " " + entity + " where " + entity + ".visibility = " + OwnedResource.Visibility.PUBLIC.ordinal()+" order by id * 1"; //
        }else {
            User authUser = (User) authentication.getPrincipal();
            queryString = "select " + entity + " from " + entityName + " " + entity + " where " + entity + ".owner.name = '" + authUser.getName() + "' or " + entity + ".visibility = " + OwnedResource.Visibility.PUBLIC.ordinal()+" order by id * 1"; //
        }
